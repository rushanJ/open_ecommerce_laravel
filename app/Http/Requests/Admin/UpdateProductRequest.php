...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('products', 'slug')->ignore($product->getKey())],
            'sku' => ['nullable', 'string', 'max:100', Rule::unique('products', 'sku')->ignore($product->getKey())],
